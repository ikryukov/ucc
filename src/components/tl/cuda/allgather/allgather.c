...
#ifdef HAVE_NVLS
        [UCC_TL_CUDA_ALLGATHER_ALG_NVLS] =
            {.id   = UCC_TL_CUDA_ALLGATHER_ALG_NVLS,
             .name = "nvls",
             .desc = "NVLS allgather algorithm"},
#endif /* HAVE_NVLS */
                                        ...
                                        ucc_coll_task_t **task_p)
{
    ...
    if (team->topo == NULL) {
        return ucc_tl_cuda_allgather_nvls_init(coll_args, tl_team, task_p);
    }
#endif
